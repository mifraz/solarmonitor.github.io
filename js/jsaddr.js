...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function cmbSelect(cmb, str)
	{
		...
		for(var i=0; i<cmb.options.length; i++)
		{
			...
			if(str != undefined){
				if( str.indexOf(cmb.options[i].value) != -1)
			{
...
{name:'广东省', cityList:[		   
{name:'广州市', areaList:['市辖区','东山区','南沙区','越秀区','海珠区','天河区','白云区','黄埔区','番禺区','花都区','增城市','从化市']},	   
{name:'韶关市', areaList:['市辖区','武江区','浈江区','曲江区','始兴县','仁化县','翁源县','乳源瑶族自治县','新丰县','乐昌市','南雄市']},		   
{name:'深圳市', areaList:['市辖区','罗湖区','坪山区','福田区','南山区','宝安区','光明区','龙岗区','盐田区','龙华区','大鹏新区']},		   
